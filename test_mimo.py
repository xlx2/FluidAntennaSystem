...
def get_args():
    ...
    parser.add_argument("--num_antennas", type=int, default=8, help="Number of transmit antennas (N)")
    ...
    parser.add_argument("--antenna_spacing", type=float, default=0.5, help="Spacing between antennas")
...
def get_parameters(args):
    ...
    antenna_indices = np.arange(args.num_antennas).reshape(-1, 1)
    ...
    H = MIMO_Channel(N=args.num_antennas, N_user=args.num_users).get_channel()
